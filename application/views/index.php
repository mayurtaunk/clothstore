                ...
                <ul class="nav">
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src=<?php echo base_url('img/tags/repo.png'); ?> style="width : 70px; height : 70px;">Reports</a>
                      <ul class="dropdown-menu">
                        <li <?php if($this->session->userdata('current_tab') == 'cst_rep') { echo "class='active'"; } ?>> <a href=<?php echo site_url('reports/creditreport');?>><img src=<?php echo base_url('img/tags/stock.png'); ?> style="width : 50px; height : 50px;"> Stock Report</a></li>
                        ...
                        <li <?php if($this->session->userdata('current_tab') == 'pur_rep') { echo "class='active'"; } ?>> <a href=<?php echo site_url('reports/purchasecredit');?>><img src=<?php echo base_url('img/tags/credit.png'); ?> style="width : 50px; height : 50px;">Purchase Credit</a></li>
